...
export function Actions({ poytakirja, remove }: { poytakirja: Poytakirja, remove: () => void }) {
  return (
    <>
      <h2>Nuorisovaltuuston kokous {poytakirja.date}</h2>
      <Group>
        <Group>
          <Button leftIcon={<IconPrinter size={14} />} onClick={() => {
        ...
        <Button color="red" leftIcon={<IconTrash size={14} />} onClick={() => remove()}>
          Poista
        </Button>
      </Group>
    </>
